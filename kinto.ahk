...
Menu, Tray, Tip, Apple - Kinto                          ; MacModifiers
...
;     ; $LCtrl::LAlt     ; CB/IBM
       ...
       $RCtrl::LAlt   ; WinModifiers
       $LWin::Alt    ; WinModifiers
...
; #########################################################################
    ...
    ; Layout switch on Alt+Z (I'm just used to it. Remove the ';' if you'd like to try it)
    ;$!z::Send {Alt down}{Shift down}{Alt up}{Shift up}   ; For standard Alt+Shift combination
    $!z::Send {vkC0}   ; For lang switch on Greave (doesn't interfere with Alt+Shift level keys)

    ; Russian layout fix
    #If GetLayout(Language := "") = "ru"
    $\::Send,   {U+0451} ; Cyrillic: ё
    $+\::Send,  {U+0401} ; Cyrillic: Ё

    $`::Send,   {U+0060} ; Grave Accent: `
    $+`::Send,  {U+007E} ; Tilde: ~

    $+4::Send,  {U+0025} ; Percent sign: %
    $+5::Send,  {U+003A} ; Colon: :
    $+6::Send,  {U+002C} ; Comma: ,
    $+7::Send,  {U+002E} ; Period: .
    $+8::Send,  {U+003B} ; Semicolon: ;
    ...
    $!9::Send,  {U+007B} ; Left curly bracket: {
    $!0::Send,  {U+007D}   ; Right curly bracket: }
    $!-::Send,  {U+2013} ; En Dash symbol: –
    ...
    $!,::Send,  {U+2264} ; Less than or equal to symbol {U+2264}: ≤
    $!+,::Send, {U+003C} ; Less than symbol {U+003C}: <
    $!.::Send,  {U+2265} ; Greater than or equal to symbol {U+2265}: ≥
    $!+.::Send, {U+003E} ; Greater than symbol {U+003D}: >
